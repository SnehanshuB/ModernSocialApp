...
void main() async{
  ...
  Platform.isAndroid? await Firebase.initializeApp(
    options: const FirebaseOptions(apiKey: Secrets.apiKey, appId: Secrets.appId, messagingSenderId: Secrets.messagingSenderId, projectId: Secrets.projectId, storageBucket: Secrets.storageBucket)
